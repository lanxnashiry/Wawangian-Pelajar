...
1. **`BUILD_SPEC.md`** (v2.8) — PRD / spesifikasi. Sumber kebenaran requirement.
...
4. **`DECISIONS.md`** — semua keputusan **KEP-001 s/d KEP-049**. Patuhi; jangan
...
Nomor terpakai terakhir: **KEP-049**. Berikutnya `KEP-050`.
