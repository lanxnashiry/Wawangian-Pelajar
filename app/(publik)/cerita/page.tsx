...
export default async function HalamanDaftarCerita() {
  ...
  return (
    <main>
      <section className="bg-[#102A43] px-5 py-14 text-white sm:px-8 sm:py-20 lg:px-10">
      ...
      <section className="px-5 py-12 sm:px-8 sm:py-16 lg:px-10">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="mt-12 flex flex-col gap-5 rounded-3xl border border-[#E5D4B3] bg-[#FAF7F1] p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
            ...
            <Link
              href="/donasi"
              className="inline-flex min-h-12 shrink-0 items-center justify-center rounded-full bg-[#102A43] px-5 py-3 text-sm font-black text-white"
            >
              Kenali Dana Cahaya
            </Link>
          </div>
