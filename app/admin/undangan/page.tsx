    ...
    <main className="flex min-h-svh items-center justify-center bg-[#F4EBDD] px-5 py-12">
      <div className="w-full max-w-md rounded-[2rem] border border-[#DED3C2] bg-white p-6 shadow-xl shadow-[#102A43]/8 sm:p-8">
        <Link href="/" className="inline-flex items-center gap-3 font-black text-[#102A43]">
          <Image src="/logo-wawangian-pelajar-resmi.png" alt="Monogram WAWANGIAN PELAJAR" width={48} height={48} className="rounded-xl" />
          Wawangian Pelajar
        </Link>
        <p className="mt-8 text-xs font-black tracking-[0.16em] text-[#087477] uppercase">
          Aktivasi Admin
        </p>
        <h1 className="mt-3 text-3xl font-black tracking-tight text-[#102A43]">
        ...
        {data.user ? (
          <>
            ...
            {pesan ? (
              <p
                role="status"
                className="mt-5 rounded-2xl border border-[#E5D4B3] bg-[#FAF7F1] px-4 py-3 text-sm text-[#6D5426]"
              >
                {pesan}
              </p>
            ) : null}
            <form action={simpanKataSandiAdmin} className="mt-6 space-y-5">
              <label className="block text-sm font-bold text-[#102A43]">
                ...
                <input
                  ...
                  className="mt-2 h-12 w-full rounded-xl border border-[#CFC3B2] px-4 font-normal outline-none focus:border-[#087477] focus:ring-3 focus:ring-[#087477]/10"
                />
              </label>
              <label className="block text-sm font-bold text-[#102A43]">
                Ulangi kata sandi
              ...
              <button className="min-h-12 w-full rounded-full bg-[#087477] px-5 py-3 text-sm font-black text-white hover:bg-[#075E61]">
        ...
        <p className="mt-6 text-center text-xs leading-5 text-[#687078]">
