...
export default async function DasborDonasiAdmin() {
  ...
  return (
    <main className="p-5 sm:p-8 lg:p-10">
      ...
      <p className="mt-3 max-w-2xl text-sm leading-6 text-[#282B2F]">Angka terkumpul dihitung otomatis dari laba bersih setiap transaksi × 20%. Hanya penyaluran berbukti dan bersaldo cukup yang dapat diterbitkan.</p>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-3">
        <Link href="/admin/donasi/rekap" className="rounded-2xl border border-[#DED3C2] bg-white p-5 hover:border-[#087477]"><h2 className="font-black text-[#102A43]">Rekap penjualan → donasi</h2><p className="mt-2 text-sm leading-6 text-[#282B2F]">Catat laba bersih transaksi atau periode serta metode sumber. Sistem menetapkan bagian donasi 20%.</p></Link>
