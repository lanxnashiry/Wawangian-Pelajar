...
export default async function DaftarKontenAdmin({ searchParams }: Properti) {
  ...
  return <main className="p-5 sm:p-8 lg:p-10">
    <div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-xs font-black tracking-[0.16em] text-[#087477] uppercase">Mesin konten</p><h1 className="mt-3 text-3xl font-black text-[#102A43]">Artikel</h1></div><div className="flex flex-wrap gap-3"><Link href="/admin/entri-massal" className="rounded-full border border-[#087477] px-5 py-3 text-sm font-black text-[#087477]">Entri massal</Link><Link href="/admin/konten/baru" className="rounded-full bg-[#087477] px-5 py-3 text-sm font-black text-white">+ Artikel baru</Link></div></div>
