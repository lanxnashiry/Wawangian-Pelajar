  ...
  return (
    <main className="bg-[#F4EBDD] px-5 py-10 sm:px-8 sm:py-14">
      <section className="mx-auto w-full max-w-2xl rounded-[2rem] border border-[#DED3C2] bg-white p-6 shadow-xl shadow-[#102A43]/8 sm:p-8">
        <Link href="/" className="inline-flex items-center gap-3 font-black text-[#102A43]"><Image src="/logo-wawangian-pelajar-simbol.webp" alt="Logo Wawangian Pelajar" width={48} height={48} className="rounded-xl" /> Wawangian Pelajar</Link>
